...
\hhline{|-|-}
	...
	{\gnumericPB{\centering}\gnumbox{{\color[rgb]{0.79,0.13,0.1} VAMAN LC PINS}}}
...
\begin{center}
\fbox{\parbox{8cm}{\url{https://github.com/likhith1101/fwcassgn/tree/main/Bluetooth-controlled-Digitalmode/codes}}}
\end{center}
\begin{center}
\end{center}
\begin{lstlisting}
svn co https://github.com/likhith1101/fwcassgn/tree/main/Bluetooth-controlled-Digitalmode
cd codes
pio run
pio run -t upload
\end{lstlisting}
